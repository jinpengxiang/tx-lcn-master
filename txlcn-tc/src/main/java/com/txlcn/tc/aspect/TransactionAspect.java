 ...
 */
package com.txlcn.tc.aspect;

import com.txlcn.tc.aspect.weave.DTXLogicWeaver;
import com.txlcn.tc.config.TxClientConfig;
import com.txlcn.common.util.Transactions;
import com.txlcn.tc.annotation.*;
import com.txlcn.tc.annotation.*;
...
public class TransactionAspect implements Ordered {
     ...
     */
    @Pointcut("@annotation(com.txlcn.tc.annotation.TxTransaction)")
     ...
     */
    @Pointcut("@annotation(com.txlcn.tc.annotation.LcnTransaction)")
     ...
     */
    @Pointcut("@annotation(com.txlcn.tc.annotation.TxcTransaction)")
     ...
     */
    @Pointcut("@annotation(com.txlcn.tc.annotation.TccTransaction)")
    ...
    @Around("this(com.txlcn.tc.annotation.ITxTransaction) && execution( * *(..))")
