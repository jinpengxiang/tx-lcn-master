 ...
 */
package com.txlcn.tc.core.transaction.lcn.control;

import com.alibaba.fastjson.JSONObject;
import com.txlcn.common.exception.TransactionException;
import com.txlcn.tc.core.DTXLocalContext;
import com.txlcn.tc.core.TxTransactionInfo;
import com.txlcn.tc.core.DTXLocalControl;
import com.txlcn.tc.core.context.TCGlobalContext;
import com.txlcn.tc.core.template.TransactionControlTemplate;
...
//        //TODO 事务参数
        log.info("=============" + info.getTransactionType() + "事务：接口类" + info.getTransactionInfo().getTargetClazz().getName());
        log.info("=============" + info.getTransactionType() + "事务：接口方法" + info.getTransactionInfo().getMethod());
        log.info("=============" + info.getTransactionType() + "事务：接口参数" + JSONObject.toJSON(info.getTransactionInfo().getArgumentValues()[0]));
    }
