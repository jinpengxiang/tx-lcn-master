 ...
 */
package com.txlcn.tc.core.context;

import com.txlcn.common.exception.TCGlobalContextException;
import com.txlcn.common.exception.TransactionException;
import com.txlcn.common.util.function.Supplier;
import com.txlcn.tc.config.TxClientConfig;
import com.txlcn.tc.core.TccTransactionInfo;
import com.txlcn.tc.core.transaction.lcn.resource.LcnConnectionProxy;
import com.txlcn.tc.core.transaction.txc.analy.def.PrimaryKeysProvider;
import com.txlcn.tc.core.transaction.txc.analy.def.bean.TableStruct;
import com.txlcn.tracing.TracingContext;
