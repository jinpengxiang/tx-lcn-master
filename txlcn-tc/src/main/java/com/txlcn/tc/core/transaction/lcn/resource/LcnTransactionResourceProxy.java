 ...
 */
package com.txlcn.tc.core.transaction.lcn.resource;

import com.txlcn.common.exception.TCGlobalContextException;
import com.txlcn.tc.aspect.weave.ConnectionCallback;
import com.txlcn.tc.core.DTXLocalContext;
import com.txlcn.tc.core.context.TCGlobalContext;
import com.txlcn.tc.support.resouce.TransactionResourceProxy;
